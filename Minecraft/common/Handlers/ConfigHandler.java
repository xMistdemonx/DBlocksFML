...
public class ConfigHandler {
	...
	public static void init(File configFile) {
		...
		try {
			...
			DBlocksIDS.Grinder_Block_ID = config.getOrCreateIntProperty("Grinder_Block_ID", "BLOCKS", 219).getInt(219);

			DBlocksIDS.RecordPlayer_Block_ID = config.getOrCreateIntProperty("RecordPlayer_Block_ID", "BLOCKS", 220).getInt(220);
			...
			DBlocksIDS.AmethystDust_ID = config.getOrCreateIntProperty(" AmethystDust_ID", "ITEMS", 3003).getInt(3003);
			DBlocksIDS.AzurDust_ID = config.getOrCreateIntProperty(" AzurDust_ID", "ITEMS", 3004).getInt(3004);
			DBlocksIDS.CitrineDust_ID = config.getOrCreateIntProperty(" CitrineDust_ID", "ITEMS", 3005).getInt(3005);
			DBlocksIDS.Plank_ID = config.getOrCreateIntProperty(" Plank_ID", "ITEMS", 3006).getInt(3006);
			DBlocksIDS.WoodFrameStrip_ID = config.getOrCreateIntProperty(" WoodFrameStrip_ID", "ITEMS", 3007).getInt(3007);
			DBlocksIDS.WoodFrame_ID = config.getOrCreateIntProperty(" WoodFrame_ID", "ITEMS", 3008).getInt(3008);
			DBlocksIDS.LampFrame_ID = config.getOrCreateIntProperty(" LampFrame_ID", "ITEMS", 3009).getInt(3009);
			
			
			
			//DarkStone Tools-----------------------------------------------------------------------------------------------------------------------------
			DBlocksIDS.DSP_ID = config.getOrCreateIntProperty(" DSP_ID", "ITEMS", 30010).getInt(3010);
			DBlocksIDS.DSA_ID = config.getOrCreateIntProperty(" DSA_ID", "ITEMS", 3011).getInt(3011);
			DBlocksIDS.DSH_ID = config.getOrCreateIntProperty(" DSH_ID", "ITEMS", 3012).getInt(3012);
			DBlocksIDS.DSS_ID = config.getOrCreateIntProperty(" DSS_ID", "ITEMS", 3013).getInt(3013);
			DBlocksIDS.DSSw_ID = config.getOrCreateIntProperty(" DSSw_ID", "ITEMS", 3014).getInt(3014);
			
			
			
			
			//LightStone Tools----------------------------------------------------------------------------------------------------------------------------
			DBlocksIDS.LSP_ID = config.getOrCreateIntProperty(" LSP_ID", "ITEMS", 3015).getInt(3015);
			DBlocksIDS.LSA_ID = config.getOrCreateIntProperty(" LSA_ID", "ITEMS", 3016).getInt(3016);
			DBlocksIDS.LSH_ID = config.getOrCreateIntProperty(" LSH_ID", "ITEMS", 3017).getInt(3017);
			DBlocksIDS.LSS_ID = config.getOrCreateIntProperty(" LSS_ID", "ITEMS", 3018).getInt(3018);
			DBlocksIDS.LSSw_ID = config.getOrCreateIntProperty(" LSSw_ID", "ITEMS", 3019).getInt(3019);
