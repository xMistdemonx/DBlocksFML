...
public class SLABZ extends Block {
	...
	public void updateBlockMetadata(World par1World, int par2, int par3,
			int par4, int par5, float par6, float par7, float par8) {
		if (!this.isDoubleSlab) {
			if (par5 == 0 || par5 != 1 && (double) par7 > 0.5D) {
				int var9 = par1World.getBlockMetadata(par2, par3, par4) & 7;
				par1World
						.setBlockMetadataWithNotify(par2, par3, par4, var9 | 8);
			}
		}
	}

	public int idDropped(int i, Random random, int j) {
		// change mod_K3Core.BloodCobbleHalfSlab.blockID to your mod_**** block
		// id
		return halfID;
	}
