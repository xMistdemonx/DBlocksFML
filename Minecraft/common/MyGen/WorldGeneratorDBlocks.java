...
//(Max y - min y) + min y
	public void generateSurface(World world, Random rand, int chunkX, int chunkZ)
	{
		...
		for (int i = 0; i < 30; i++)
		{
			...
			for (int i = 0; i < 30; i++)
			{
				...
				int randPosY = rand.nextInt(10);
				int randPosZ = chunkZ + rand.nextInt(16);
				new WorldGenMinable(DBlocksIDS.Topaz_BLOCK_ID, 16).generate(world, rand, randPosX, randPosY, randPosZ);
			}
			for (int i = 0; i < 30; i++)
			{
				int randPosX = chunkX + rand.nextInt(16);
				int randPosY = rand.nextInt(10);
				int randPosZ = chunkZ + rand.nextInt(16);
				new WorldGenMinable(DBlocksIDS.Aquamarine_BLOCK_ID, 16).generate(world, rand, randPosX, randPosY, randPosZ);
			}
			for (int i = 0; i < 30; i++)
			{
				int randPosX = chunkX + rand.nextInt(16);
				int randPosY = rand.nextInt(10);
				int randPosZ = chunkZ + rand.nextInt(16);
				new WorldGenMinable(DBlocksIDS.Peridot_BLOCK_ID, 16).generate(world, rand, randPosX, randPosY, randPosZ);
			}
	...
	public void generateNether(World world, Random rand, int chunkX, int chunkZ)
	{
		...
		for (int i = 0; i < 10; i++)
		{
			...
			int randPosY = rand.nextInt(128);
			int randPosZ = chunkZ + rand.nextInt(10);
			new WorldGenOre(DBlocksIDS.NetherTopaz_BLOCK_ID, 10).generate(world, rand, randPosX, randPosY, randPosZ);
		}
		for (int i = 0; i < 10; i++)
		{
			int randPosX = chunkX + rand.nextInt(15);
			int randPosY = rand.nextInt(128);
			int randPosZ = chunkZ + rand.nextInt(10);
			new WorldGenOre(DBlocksIDS.NetherAquamarine_BLOCK_ID, 10).generate(world, rand, randPosX, randPosY, randPosZ);
		}
		for (int i = 0; i < 10; i++)
		{
			int randPosX = chunkX + rand.nextInt(15);
			int randPosY = rand.nextInt(128);
			int randPosZ = chunkZ + rand.nextInt(10);
			new WorldGenOre(DBlocksIDS.NetherPeridot_BLOCK_ID, 10).generate(world, rand, randPosX, randPosY, randPosZ);
		}
